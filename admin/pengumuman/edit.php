<?php 
    ...
    include '../../config/koneksi.php';
      ...
      $id = $_GET['id'];
      $data = $koneksi->query("SELECT * FROM pengumuman WHERE id_p = '$id'");
        ...
        <div class="col-md-12">
            ...
            <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea type="text" class="form-control" name="judul" required=""><?php echo $row['judul'];?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <textarea class="textarea" name ="isi"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $row['isi'];?></textarea>
                        </div>
                    </div>
...
<?php 
    ...
    $submit = $koneksi->query("UPDATE pengumuman SET  judul = '$judul', isi = '$isi', tgl_p = '$tgl_p' WHERE id_p = '$id'");
