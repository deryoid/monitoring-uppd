<?php 
    ...
    include '../../config/koneksi.php';
      ...
      $id = $_GET['id'];
      $data = $koneksi->query("SELECT * FROM ttd_uppl WHERE idTtd = '$id'");
        ...
        <div class="col-md-12">
            <div class="card card-dark">
                <div class="card-header">
                    <h3 class="card-title">Form Edit Kepala UPPL</h3>
                </div>
            ...
            <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" name="kepalaUppl" value="<?= $row['kepalaUppl'] ?>">
                        </div>
                    </div>
...
<?php 
    ...
    $submit = $koneksi->query("UPDATE ttd_uppl SET nip = '$nip', kepalaUppl = '$kepalaUppl', jabatan = '$jabatan' WHERE idTtd = '$id'");
