<?php 
    ...
    include '../../config/koneksi.php';
      ...
      $id = $_GET['id'];
      $data = $koneksi->query("SELECT * FROM user_role WHERE id_role = '$id'");
...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Role User</h1>
        </div>
        ...
        <div class="col-md-12">
            ...
            <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="role" required="" value="<?= $row['role'] ?>">
                        </div>
                    </div>
...
<?php 
    ...
    $submit = $koneksi->query("UPDATE user_role SET role = '$role' WHERE id_role = '$id'");
    session_start();
