        ...
        <div class="col-md-12">
            <div class="card card-dark">
                <div class="card-header">
                    <h3 class="card-title">Form Edit Data Surat Masuk</h3>
                </div>
            ...
            <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <span class="badge badge-success"><?= $row['tgl_sm'] ?></span></span>
                        </div>
                    </div>                    
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" name="no_sm" value="<?= $row['no_sm'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                        <textarea type="text" class="form-control" name="isi_sm" ><?= $row['isi_sm'] ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                        <input type="date" class="form-control" name="tgl_t_sm" value="<?= $row['tgl_t_sm'] ?>">
                        </div>
                    </div>
...
<?php 
    ...
    $submit = $koneksi->query("UPDATE surat_masuk SET  no_sm = '$no_sm', isi_sm = '$isi_sm', tgl_t_sm = '$tgl_t_sm' WHERE id_sm = '$id'");
    session_start();
