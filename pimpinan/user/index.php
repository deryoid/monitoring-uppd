...
<div class="row">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <a href="create" class="btn btn-primary"><i class="fa fa-plus-circle mr-1"></i>Tambah User</a>
            </h3>
        </div>
                ...
                <tbody>
                    ...
                    <td><?= $row['role'] ?></td>
                        <td align="center">
                            ...
                            <a href="delete?id=<?= $row['id_user'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
