  ...
  <a href="#" class="brand-link">
      <img src="<?=base_url()?>/assets/dist/img/favicon1.png" style="width: 30px;" alt="#" class="brand-image"
        style="opacity: .8">
      <span class="brand-text font-weight-light"><b>Administrasi Magang</b></span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
              ...
              <?php 
                if ($_SESSION['role'] == "Admin"){
                  echo "Admin";
                    ...
                    $data = $koneksi->query("SELECT * FROM mahasiswa WHERE id_mhs = '$_SESSION[id_mhs]'")->fetch_array();
                    echo $data['nama'];
                  }elseif ($_SESSION['role'] == "Dosen") {
                    $data2 = $koneksi->query("SELECT * FROM dosen WHERE id_dosen = '$_SESSION[id_dosen]'")->fetch_array();
                    echo $data2['nama_dosen'];
                  }  
              ?>
          </i>
        </a>
